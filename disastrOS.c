...
void disastrOS_start(void (*f)(void*), void* f_args, char* logfile){  
  ...
  syscall_numarg[DSOS_CALL_SEMOPEN]      = 2; //modificato
  ...
  syscall_numarg[DSOS_CALL_SEMPOST]      = 1; //modificato
...
//implementazione delle funzioni dei semafori tramite uso di syscall il cui numero è presente nella tabella delle syscall
